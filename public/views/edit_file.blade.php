...
<body>
  ...
  <main class="container" style="margin-top: 100px">
    <h1 class="font-weight-bold"><i class="fa fa-edit"></i> ویرایش فایل <span dir="ltr">فلان</span></h1>
    <form method="post">
      <div class="form-group">
        <textarea dir="ltr" class="form-control" name="content" id="content" rows="10" autofocus>محتوا</textarea>
      </div>
