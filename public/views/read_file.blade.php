...
<body>
  <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbar">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
          <a class="nav-link" href="./add_user.html"><i class="fa fa-plus"></i> افزودن کاربر جدید</a>
        </li>
        <li class="nav-item">
  ...
  <main class="container" style="margin-top: 100px">
    <h1 class="font-weight-bold"><i class="fa fa-edit"></i> محتوای فایل <span dir="ltr">فلان</span></h1>
    <form method="post">
      <div class="form-group">
        <textarea readonly dir="ltr" class="form-control" name="content" id="content" rows="10" autofocus>محتوا</textarea>
      </div>
