...
<body>
  ...
  <main class="container" style="margin-top: 100px">
    <h1 class="font-weight-bold"><i class="fa fa-edit"></i> محتوای فایل <span dir="ltr">{{ $file->name }}</span></h1>
    <form method="post">
      <div class="form-group">
        <textarea readonly dir="ltr" class="form-control" name="content" id="content" rows="10" autofocus>{{ $file->content }}</textarea>
      </div>
